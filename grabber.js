...
let treeObj = {
    ...
    openCourseList: async function(){
        ...
        return new Promise(resolve => {
            setTimeout(async function tick(){
                let openedCourses = $('.filter-head__categories-info span:nth-child(1)')[0].innerText;
                let summaryCourses = $('.filter-head__categories-info span:nth-child(3)')[0].innerText;
